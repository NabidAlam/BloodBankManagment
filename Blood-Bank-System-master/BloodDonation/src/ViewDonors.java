...
public class ViewDonors extends javax.swing.JFrame {
   ...
   ArrayList<Donor> donorList;
    TableModel viewDonorsTableModel;
    ...
    public ViewDonors() {
        ...
        viewDonorsTableModel = new TableModel();
        generateList("All","");
        viewDonorsTable.setModel(viewDonorsTableModel);
        ...
        try
        {
            ...
            switch(action)
            {
                ...
                case "Blood Group":
                    ...
                    break;
                case "Gender":
                    rs = stmt.executeQuery("select * from donor where donor_sex='"+type+"'");
                    break;
                case "Last Donation":
                    if(type.equals("Old"))
                    {
            ...
            while(rs.next())
            {
                ...
                Donor d = new Donor(count,rs.getString("donor_name"),rs.getString("donor_sex"),rs.getString("donor_blood_group"),rs.getString("email"),rs.getString("donor_occupation"),getAge(rs.getString("donor_dob")));  
                donorList.add(d);
                count++;
            }
    ...
    {
        String columnName[] = {"S.No.","Name","Gender","Age","Blood","Email","Occupation","Details"};
        @Override
        ...
        public Object getValueAt(int rowIndex, int columnIndex) 
        {
            switch(columnIndex)
            {
                ...
                case 5:
                    return donorList.get(rowIndex).email;
                case 6:
                    return donorList.get(rowIndex).occupation;
                case 7:
                        return "View";
            }
            return 0;
   ...
   class Donor
   {
       String name,gender,bloodGroup,email,occupation;
       int number,age;

        public Donor(int number, String name, String gender, String bloodGroup, String email, String occ, int age) 
        {
            this.name = name;
            this.gender = gender;
    ...
    private void initComponents() {
        ...
        viewDonorsFilterCombo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "All", "Blood Group", "Gender" }));
    ...
    private void viewDonorsFilterGoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDonorsFilterGoButtonActionPerformed
        ...
        viewDonorsTable.getColumn("Details").setCellEditor(new ButtonEditor(new JCheckBox(),listOfIds,"donors"));
        viewDonorsTableModel.fireTableDataChanged();
